...
/**
 * Stage defaults for the CIBA board. Live size and yes-threshold come
 * from BOARD_SIZE and CIBA_YES_THRESHOLD env (lib/board-config.ts),
 * read at runtime. Clients must use the API / claim snapshot — this
 * module is shared with client components and must not touch process.env.
 */
